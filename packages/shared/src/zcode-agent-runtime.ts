...
export interface ZCodeAgentRuntimeDescriptor {
  ...
  /**
   * 桌面端把 agent 的 JS bundle（zhlbuilder.cjs）打进 resources/glm，由 app 内置的 Electron Node runtime
...
export const ZCODE_AGENT_RUNTIME: ZCodeAgentRuntimeDescriptor = {
  ...
  nativeConfigDir: ".zhlbuilder/cli",
  ...
  nodeBundleEntryFile: "zhlbuilder.cjs",
