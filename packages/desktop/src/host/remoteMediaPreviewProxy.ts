...
import type { IFileService, IMediaPreviewService, MediaPreviewPreparation } from "@zhlbuilder/services";
import { getMediaPreviewFormat, type WindowHostAttachmentScope } from "@zhlbuilder/shared";
import {
