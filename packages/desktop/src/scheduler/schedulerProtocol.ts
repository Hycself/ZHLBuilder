...
// 与 host↔main 的 CronRun/CronRunResult(见 @zhlbuilder/shared channels + validation)不同：
// 这层是 main 与「常驻 cron scheduler 进程」之间的私有通道；main 收到派发请求后再翻译成 CronRun 转发给 host。
import type { ModelSelection, NodeSelfResourceSample } from "@zhlbuilder/shared";
