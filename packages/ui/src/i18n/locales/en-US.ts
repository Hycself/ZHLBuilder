...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like ZHLBuilder to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let ZHLBuilder remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting ZHLBuilder",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen ZHLBuilder.",
  ...
  "startup.global.starting_services": "Starting ZHLBuilder",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "ZHLBuilder will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another ZHLBuilder or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen ZHLBuilder. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen ZHLBuilder to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen ZHLBuilder.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a ZHLBuilder restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into ZHLBuilder",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to ZHLBuilder and try again",
  ...
  "bots.title": "Bots",
  "bots.description": "Connect external chats and webhooks to ZHLBuilder bots.",
  "bots.listTitle": "Bots",
  "bots.addBot": "New bot",
  ...
  "bots.setup.guide.weixin.create.2":
    "ZHLBuilder saves the bot_token returned by iLink automatically; after scanning, send any message to the bot in Weixin to activate the chat.",
  "bots.setup.guide.weixin.create.3":
    "ZHLBuilder uses a built-in iLink client: `/ilink/bot/getupdates` for long polling and `/ilink/bot/sendmessage` for replies.",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook mode does not require a native bot in the third-party product; your integration only needs to POST messages to ZHLBuilder.",
  ...
  "bots.setup.guide.webhook.bind.1":
    "POST a private-message callback to ZHLBuilder's `/api/bots/webhook` endpoint.",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere":
    "Telegram long polling is handled by another ZHLBuilder window.",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to ZHLBuilder",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to ZHLBuilder",
  "login.description": "Connect your account to start using ZHLBuilder",
  ...
  "logout.confirm.title": "Disconnect and restart ZHLBuilder?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only ZHLBuilder Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About ZHLBuilder",
  ...
  "titleBar.menu.help.toggleZHLBuilderStdioTap": "Capture agent stdio traffic",
  ...
  "forceUpdate.title": "Update ZHLBuilder to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart ZHLBuilder to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the ZHLBuilder CDN and have download, extract, and checksum tools.",
  ...
  "webRemoteControl.description": "Control ZHLBuilder workspaces through chat bots.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "ZHLBuilder checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the ZHLBuilder terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While ZHLBuilder is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the ZHLBuilder installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching ZHLBuilder task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by ZHLBuilder",
  ...
  "resourceManager.storage.diskUsage": "ZHLBuilder uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the ZHLBuilder desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZHLBuilder could not verify its Windows secure import component. Reinstall or update ZHLBuilder before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, ZHLBuilder will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by ZHLBuilder Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "ZHLBuilder provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This ZHLBuilder Agent cannot refresh OAuth status. Upgrade or restart ZHLBuilder, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to ZHLBuilder to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into ZHLBuilder",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to ZHLBuilder 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by ZHLBuilder automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in ZHLBuilder.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. ZHLBuilder uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in ZHLBuilder after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "ZHLBuilder MCP",
  ...
  "sidebar.usage.plan.mcp": "ZHLBuilder MCP",
  "sidebar.usage.plan.zcodeMcp": "ZHLBuilder MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for ZHLBuilder built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into ZHLBuilder. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. ZHLBuilder follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into ZHLBuilder",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by ZHLBuilder Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend ZHLBuilder with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into ZHLBuilder and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. ZHLBuilder follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into ZHLBuilder",
  ...
  "settings.commands.description":
    "Manage ZHLBuilder Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "ZHLBuilder Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into ZHLBuilder. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. ZHLBuilder follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into ZHLBuilder",
  ...
  "settingsSync.action.finish": "Start using ZHLBuilder",
  "settingsSync.agent.zcode": "ZHLBuilder Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current ZHLBuilder settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to ZHLBuilder",
  ...
  "onboarding.welcome.title": "Welcome to ZHLBuilder",
  "onboarding.welcome.start": "Start ZHLBuilder",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while ZHLBuilder imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "ZHLBuilder will copy {source} to {target}.\nIf the target file already exists, the ZHLBuilder default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask ZHLBuilder anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask ZHLBuilder anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, ZHLBuilder will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want ZHLBuilder to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart ZHLBuilder app and retry, or ask ZHLBuilder to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with ZHLBuilder in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for ZHLBuilder: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with ZHLBuilder in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current ZHLBuilder Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'ZHLBuilder MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No ZHLBuilder MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "ZHLBuilder",
  ...
  "feedback.submit.template.section.copyErrorHeading": "ZHLBuilder Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while ZHLBuilder is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task ZHLBuilder can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "ZHLBuilder Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "ZHLBuilder Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart ZHLBuilder",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart ZHLBuilder to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified ZHLBuilder plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "ZHLBuilder will verify the Computer Use tools against the exact session when your first session starts.",
