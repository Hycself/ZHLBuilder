...
import { TID_V4_HOOK_DETAILS_CONTENT, TID_V4_HOOK_DETAILS_TRIGGER, testId } from "@zhlbuilder/shared";
import type { HookExecutionProjection, HookInvocationRow } from "@zhlbuilder/shared/zcode-protocol-v4";
