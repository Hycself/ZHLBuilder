...
import type { SessionId } from "@zhlbuilder/contracts";
...
function isBrowserSurfaceSideEffect(command: import("@zhlbuilder/contracts").BrowserCommand): boolean {
...
function isAutoScreenshotTriggerCommand(
  command: import("@zhlbuilder/contracts").BrowserCommand,
): boolean {
  if (
