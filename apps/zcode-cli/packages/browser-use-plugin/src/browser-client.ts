// 从 @zhlbuilder/core 根 barrel 导入会让 esbuild 追踪具有顶层副作用的 Agent/tool 模块，
// 把 Bash registry、subagent 和 runtime 一起打进官方插件。Browser 发布物只能依赖窄 subpath。
import { setupBrowserRuntime as setupCoreBrowserRuntime } from "@zhlbuilder/core/browser-client";
import { readNodeReplBrowserRuntimeBridge } from "@zhlbuilder/node-repl-host/runtime-bridge";
