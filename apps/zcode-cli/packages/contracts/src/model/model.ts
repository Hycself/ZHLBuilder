...
import type { ModelPropertiesData, ModelOptionSpecsData } from "@zhlbuilder/shared/model-config";

export type { ModelSelection } from "@zhlbuilder/shared/model-selection";
