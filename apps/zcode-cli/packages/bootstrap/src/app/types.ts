import type { ZCodeToolExecResource, BackgroundBashOutputResult } from "@zhlbuilder/shared";
import type { AiSdkModelAdapter } from "@zhlbuilder/adapters/model";
import type {
  AgentRuntime,
  AgentRuntimeConfig,
  ExecuteTurnOptions,
...
import type { ZCodeModelOption } from "@zhlbuilder/shared";
import type { EffectiveModelSelectionResult } from "@zhlbuilder/shared/model-selection";
export type { ZCodeModelOption } from "@zhlbuilder/shared";
...
import type { AgentTelemetryRuntimeOwner, WorkspaceHookPolicy } from "@zhlbuilder/contracts";
...
export interface ZCodeApp {
  ...
  readSubagents(input?: {
    endedCursor?: string;
    endedLimit?: number;
  }): Promise<import("@zhlbuilder/shared").ZCodeSessionSubagentsResult>;
