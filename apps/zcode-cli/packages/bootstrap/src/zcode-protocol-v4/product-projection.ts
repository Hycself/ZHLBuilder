...
import { verdictWorkspaceHookReviewRequest } from "@zhlbuilder/shared/workspace-hook-review-monotonicity";
import {
...
export class ProductProjection {
  ...
  //
  // 归约本体在 @zhlbuilder/shared 的 workflow-runs-reducer（与状态 schema 同居）：TUI 镜像要用
  // 同一份归约，两处各写一份就是两个时钟。
