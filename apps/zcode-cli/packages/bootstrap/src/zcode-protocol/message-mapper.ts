import type { ZCodeMessagePart, ZCodeMessageWithParts, ZCodeToolState } from "@zhlbuilder/shared";
import type { MessagePart, MessageWithParts, ToolState } from "@zhlbuilder/contracts";
